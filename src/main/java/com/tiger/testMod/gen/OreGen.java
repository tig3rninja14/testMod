...
public class OreGen implements IWorldGenerator{
	...
	private Block blockToReplace = Blocks.STONE; 
	@Override
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,
		...
		//Overworld
		case 0:
			runGenerator(ModBlocks.RUBY_ORE.getDefaultState(),blockAmount,chancesToSpawn, minHeight, maxHeight, BlockMatcher.forBlock(blockToReplace), world, random, chunkX, chunkZ);
		  break;
		//End
		case 1:
		  break;
